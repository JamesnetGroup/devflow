...
namespace DevFlow.Controls.Primitives
{
    internal static class IconData
    {
        ...
        internal readonly static string CHECK_CIRCLE = "M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z";
        internal readonly static string CROP = "M7,17V1H5V5H1V7H5V17A2,2 0 0,0 7,19H17V23H19V19H23V17M17,15H19V7C19,5.89 18.1,5 17,5H9V7H17V15Z";
        ...
        internal readonly static string MENU = "M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z";
    ...
    public class Icon : ContentControl
    {
        ...
        {
            get { return (GeometryIconStyle)this.GetValue(IconTypeProperty); }
